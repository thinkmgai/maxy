...
<style>
    ...
    #maxyComponent__CRASHES_BY_VERSION .maxy_component_item {
        height: 30.5vh;
        min-height: 225px;
    }
    ...
    .aibot_icon {
        width: 200px;
        height: 200px;
        background-image: url(/images/maxy/ai-bot-icon-wh.gif);
    ...
    .dark_mode .aibot_icon {
        background-image: url(/images/maxy/ai-bot-icon-bk.gif);
    }
</style>
<%-- 종합분석 --%>
<div class="dashboard">
    ...
    <ul class="dsb_radial_wrap">
        <li>
            ...
            <span data-t="dashboard.bi.install"></span>
        </li>
        <li>
            ...
            <span><img src="<c:url value="/images/maxy/icon-ios.svg"/>" alt=""></span>
        ...
        <li>
            ...
            <span><img src="<c:url value="/images/maxy/icon-android.svg"/>" alt=""></span>
            <span class="sm-text">%</span>
        </li>
        <li>
            ...
            <span data-t="dashboard.bi.mau"></span>
        ...
        <li>
            ...
            <span data-t="dashboard.bi.dau"></span>
        ...
        <li>
            ...
            <span data-t="dashboard.bi.ccu"></span>
        </li>
        <li>
            ...
            <span data-t="dashboard.bi.pv"></span>
            <i><img id="appUseCountTri" class="img_arrow" alt=""></i>
        </li>
        <li>
        ...
        <li>
            ...
            <span data-t="dashboard.bi.sleep"></span>
        </li>
        <li>
            ...
            <span data-t="dashboard.bi.login"></span>
        </li>
        <li>
        ...
        <li>
            ...
            <span data-t="dashboard.bi.log"></span>
        </li>
        <li class="ess">
            <canvas id="appErrorCount"></canvas>
            <div class="error counter" data-cnt-values="">
                <div class="counter-unit" data-cnt-loc="0" data-cnt-value="">
                    <div class="counter-number" data-cnt-js="prev"></div>
                    <div class="counter-number" data-cnt-js="current"></div>
                    <div class="counter-number" data-cnt-js="next"></div>
        ...
        <li class="ess">
            ...
            <div class="crash counter" data-cnt-values="">
                <div class="counter-unit" data-cnt-loc="0" data-cnt-value="">
                    <div class="counter-number" data-cnt-js="prev"></div>
                    <div class="counter-number" data-cnt-js="current"></div>
                    <div class="counter-number" data-cnt-js="next"></div>
    ...
    <div class="maxy_popup_common_wrap" id="maxyAiBotPopupWrap"></div>
    <div class="maxy_popup_common_wrap" id="maxyPopupWrap"></div>
    <div class="maxy_popup_common_wrap" id="maxyStackPopupWrap"></div>
    <div class="maxy_popup_common_wrap" id="maxyBiPopupWrap">

    </div>
    <!-- 상단 그래프 영역 -->
    <div class="dash_top"></div>

    <!-- 하단 그래프 영역 -->
    <div class="dash_bottom"></div>

    <div class="alarm_msg_container2"></div>
    <div class="maxy_aibot" id="maxyAibotWrap" style="display: none">
        <button class="btn_aibot" id="btnAibot"></button>
    </div>
    <div class="aibot_icon" id="iconAibot"></div>
</div>
    ...
    var DB0100 = {
        ...
        init: {
            ...
            created() {
                ...
                sessionStorage.setItem('userNo', '${loginUser.userNo}')
        ...
        func: {
            ...
            async setComponents() {
                const {v, func} = DB0100
                v.componentsConfig = JSON.parse('${componentsConfig}')
                ...
                switch (id) {
                    ...
                    case 'appMauCount' :
                        ...
                        allTitle = [
                            {"title": "dashboard.bi.all", "type": dataTypeSum},
                            {"title": "iOS", "type": dataTypeSeries0Sum},
                            {"title": "dashboard.bi.iosMonthlyAvg", "type": dataTypeSeries0Avg},
                            {"title": "Android", "type": dataTypeSeries1Sum},
                            {"title": "dashboard.bi.androidMonthlyAvg", "type": dataTypeSeries1Avg},
                        ]
                        summaryTitle = [
                            {"title": "dashboard.bi.datetime", "type": dataTypeDate},
                            {"title": "dashboard.bi.all", "type": dataTypeAll},
